...
class Member extends Model
{
 ...
 protected $table = 'member';
   ...
   protected $fillable = [
        'memberid','userid','firstname','lastname','address','city', 'gender',	'email','bloodgroup',	'createddate','hearabout','other','formno','mobileno',	'homephonenumber',	'officephonenumber','profession','birthday','anniversary','emergancyname','emergancyrelation','emergancyaddress','emergancyphonenumber','workinghourfrom','workinghourto','	amount','companyid','photo','memberpin','extra1','extra2','status',];
