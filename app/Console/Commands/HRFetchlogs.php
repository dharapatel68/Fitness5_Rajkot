...
class HRFetchlogs extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'command:hrfetchlogs';
    ...
    { 
        ...
        $deviceinfo_data = DB::table('hr_deviceinfo')
        ...
        foreach($deviceinfo_data as $deviceinfo){
         ...
         /*try {*/      
                    ...
                    $deviceevent =   DB::table('hr_deviceevent')->where('deviceid', $deviceinfo->deviceinfoid)->orderBy('deviceeventid', 'desc')->get()->first();
                    $deviceseqcountid = DB::table('hr_deviceseqcount')->where('deviceid', $deviceinfo->deviceinfoid)->orderBy('deviceseqcountid', 'desc')->get()->first();
                        ...
                        $deviceseqcounts = $deviceseqcountid->seqno;
                                ...
                                if($deviceseqcounts != $seqcount) {
                                      ...
                                      $deviceseqcount = [
                                        ...
                                        HRDeviceseqcount::insert($deviceseqcount);
  ...
  public function test(Request $request, $deviceidins){
      ...
      $deviceevent =   DB::table('hr_deviceevent')->where('deviceid', $deviceidins)->orderBy('deviceeventid', 'desc')->get()->first();
      $deviceseqcountid = DB::table('hr_deviceseqcount')->where('deviceid', $deviceidins)->orderBy('deviceseqcountid', 'desc')->get()->first();
    ...
    if ($deviceevent) {
                            ...
                            $deviceinfo = DB::table('hr_deviceinfo')
