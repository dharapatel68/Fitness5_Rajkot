                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">Add Department Name</h3>
                                </div>
                                                ...
                                                <form action="{{ route('department') }}" method="post" >
                                                    ...
                                                    <div class="row">
                                                    	<div class="form-group">
                                                    		...
                                                    		<input type="text"  id="departmentname" name="departmentname" value="{{ old('departmentname') }}" class="form-control"placeholder="Enter Department Name" required=""  maxlength="255" class="span11" autocomplete="off" />
