           ...
           <section class="content">
            ...
            @endif 
             ...
             @if ($message = Session::get('message'))
              ...
              @if (Session::has('edit_assign_level'))
              <div class="alert alert-success alert-block">
                <button type="button" class="close" data-dismiss="alert">×</button> 
                      <strong>PT level is successfully edited</strong>
                      <?php Session::forget('edit_assign_level'); ?>
              </div>
              @endif 
        ...
        <div class="col-xs-12 ">
          <div>           
            <div class="box-body">
              ...
              <button type="button" onclick="setaddmodal()" class="btn add-new bg-orange" data-toggle="modal" data-target="#modal-default" style="width: 150px;padding: 10px;">
               Assign PT Level
              </button>
              @endif
            </div>
                 ...
                 <form method="POST" role="form" id="form" action="{{ URL::route('addassignptlevel')}}"  >
                  ...
                  <div class="form-group">
                    ...
                    <label>Trainer Name</label>
                      <select class="form-control" required="" name="employee" id="employee" onchange="emp()">
                  ...
                  <div class="form-group">
                   ...
                   <input type="number" class="form-control" name="level" required placeholder="Trainer Mobile No">
                    ...
                    <label>percentage</label>
                     <input type="number" class="form-control" value="" id="percentage" name="percentage" placeholder="Enter percentage" readonly="">
                    </div>
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>
                    @if(isset($permission["'edit_assign_pt_level'"]))
                    <a href="#" class="btn add-new edit"  data-toggle="modal" data-target="#modal-default" id="editassign_pt_level_values" onclick="editassign_pt_level_values('<?php echo $ptassign->ptassignlevelid; ?>','<?php echo $ptassign->levelid; ?>','<?php echo $ptassign->percentage; ?>','<?php echo $ptassign->trainerid; ?>','<?php echo $ptassign->mobileno; ?>')" ><i class="fa fa-edit"></i></a>
                    @endif
                  </td>
