...
@endif
    ...
    <div class="wrap-contact100">
      <div class="contact100-form-title" style="background-image: url(/images/Fitness5-logo.jpg);"> <!-- style="background-image: url(/images/Fitness5-logo.jpg);" -->
        <span class="contact100-form-title-1">
           <img src="{{ asset('/images/Fitness5-logo.jpg')}}" width="100" height="50"> 
        </span>
      ...
      <div class="wrap-input100 validate-input" data-validate="Name is required">
        ...
        <div>
          <p>In consideration of my desire to engage in an exercise programme at the Fitness5.I understand and agree to following :</p>
          <span class="focus-input100"></span>
        </div><br/>
        ...
        <div>
          <ol>
            ...
            <li>Befre i Engage in any activity i have informed all my medical history to the team member of Fitness5 and have complated health history form as well as an evaluation with physical therapist to determine my risk of participating exercise.i m sumbmitting all helth report to Fitness5.</li><br/>
    ...
    <div class="col-sm-4">TEAM Fitness5</div>
  </div>
