...
@endif
  ...
  <table class="table">
    ...
    <tr>  <td>Package</td> <td>{{$scheme_name}}</td> </tr>
    <tr>  <td>Starting Date</td> <td>{{ $start_date }}</td> </tr>
    <tr>  <td>Expire Date</td>  <td>{{ $end_date }}</td>  </tr>
    <tr>  <td>Amount</td>   <td>{{$transaction_amount}}</td> </tr>
    <tr>  <td>InvoiceID</td>   <td> M{{$invoiceno}}</td> </tr>
    <tr>  <td>Transaction Type</td><td>{{$transactiontype}}</td></tr>
    <?php

      $due_date = !empty($transactionduedate) ?  $transactionduedate : '';
