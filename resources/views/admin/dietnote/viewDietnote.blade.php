...
<style type="text/css">
  ...
  <div class="content-wrapper">
    <section class="content-header"><h2>All Diet Notes</h2></section>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
                ...
                <a href="{{ url('addDietnote') }}" class="btn add-new bg-navy"><i class="fa fa-plus"></i>Add New</a>
        
               <h3 class="box-title">All Diet Notes</h3>
            </div>
            ...
            <div class="box-body" style="overflow: scroll;">
              <table id="dietnotes" class="table table-bordered table-striped">
                ...
                <tr>
                    <td>{{$dietnote->dietnote}}</td>
                  
                  <td>

                    <a href="{{ url('editDietnote/'.$dietnote->dietnoteid) }}"class="edit" title="Edit"><i class="fa fa-edit"></i></a> 
