...
.customcheck .checkmark:after {
 ...
 <div class="content-wrapper">
         ...
         <section class="content-header"><h2>Claim Session</h2></section>
...
<!-- 
                <div class="form-group">
                  <label> Actual Trainer</label>
                    ...
                    @foreach ($employees as $employee)
                      <option value="{{$employee->employeeid}}" @if($trainerid==$employee->employeeid) {{'selected'}}@endif>{{$employee->username}}</option>
                    @endforeach
                  </select>
                </div>
                ...
                <!-- <div class="form-group">
                  ...
                  <select type="time" class="form-control selectpicker" title="Select Time" data-live-search="true" data-selected-text-format="count"  data-actions-box="true" data-count-selected-text="{0} Time Selected" data-header="Select Time" required name="scheduletime" id="scheduletime">
 ...
 -->
                ...
                <!-- <div class="form-group">
                  <label>Comission (in percentage)</label>
                  </select>
                </div>
                <div class="form-group">
                  <label>Amount</label>
                 ...
                 <!-- <script type="text/javascript">
                  $('#packageid').change(function(){
                    ...
                    // alert(member);
                              ...
                              $.ajax({
                                   url:"{{ URL::route('getpriceofpackage') }}",
                                   method:"GET",
                                   data:{"_token": "{{ csrf_token() }}",'schemeid':$('#packageid').val()},
                                  success:function(data) {
                                    // swal(data,"Successfully",'success');
                                    // var p=data.substring(1);
                                    var l=data.length;
                                    p=data.substring(1,l-1);
                                    // alert(p);
                                    price=(parseInt(p)*$('#comission').val())/100;
                                      // alert(data);
                                    // alert(price);
                                    $('#amount').val(price);
      ...
      <div class="modal-dialog modal-md">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button name="skip" type="button" id="skip" class="btn btn-info">Skip</button>

                <button type="button" id="close" data-dismiss="modal" class="btn btn-default" >Close</button>
                
                <button name="assigntrainer" id="assigntrainer" type="submit" class="btn btn-primary">Save</button>
