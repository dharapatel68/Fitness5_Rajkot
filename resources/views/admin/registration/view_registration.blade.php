          ...
          <div class="box">
            ...
            <?php $permission = unserialize(session()->get('permission')); ?>
               @if(isset($permission["'add_registration'"]))
                <a href="{{ url('registration#tologin') }}" class="pull-right  bowercomponentscustomedarkbluebtn  add-new bg-navy" style="width: 165px;"><i class="fa fa-plus"></i>&nbsp;<b>New Registration</b></a>
                @endif
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped dataTable">
                ...
                <tr>
                  ...
                  <td>
                    @if($registrationfields->rstatus == 1)
                      Active
                    @else
                      Deactive
                    @endif
                  ...
                  <td>
                    ...
                    <a href="{{url('regconvertmember/'.$registrationfields->id)}}" title="Convert Into Member"><i class="fa fa-user-plus" style="color: #05BD6C;"></i></a>
                     <a href="{{ route('deletereg', $registrationfields->id) }}"  title="Delete" class="delete" title="Delete"><i class="fa fa-trash"></i></a>
