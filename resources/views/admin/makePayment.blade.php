      ...
      <div class="form-group">
        <tr><td>
          <label>Total Amount</label>&emsp;</td>  
             ...
             <td><input type="text"  name="rtotal" class="form-control form-inline" placeholder="Remaining amount" id="ramount"  class="span11" readonly="" /></td></tr>  <tr><td><label>Due Date</label></td><td><input type="date" onkeypress="return false" name="duedate"  class="form-control" id="duedate" name="duedate"min="<?php echo date("Y-m-d");?>"> </td></tr></div>
        </table>
  </div>
  <div class="col-lg-5">
    <table>
...
<div class="col-lg-8 col-md-offset-4" style="height: 100px;">
  <br>
    <div>
       <button type="button" id="save" value="button" class="btn bg-blue margin" onclick="checkform()">
         Save</button>
 <!--    <button type="submit" class="btn bg-orange btn-block" onclick="checkform()">
  ...
  <div class="modal fade" id="myModalpayment" role="dialog"  data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
         <p>Are you sure want to take payment ?</p>
        </div>
          
        <div class="modal-footer">

         
          <button id="submit" type="submit" class="btn bg-blue margin" style="display: none;"> Pay </button>
           <button id="saveprint" type="button"style="margin-top: -1px;"  class="btn bg-blue margin" onclick="abcd()"> Pay </button>
