               ...
               <form class="form-inline" method="POST" action="{{route('assignPTTime')}}">
                ...
                <!-- <div class="form-group">
                  <div class="input-group date" style="max-width:180px" id="date">
                    <input type="date" onkeypress="return false" class="form-control" name="date" placeholder="Date" />
              ...
              <form method="POST" action="{{URL::route('editpttime')}}" >
                {{csrf_field()}}
                  ...
                  <div class="input-group " style="max-width:180px" >
                    ...
                    <input type="date" onkeypress="return false" value="{{$todate}}" class="form-control" name="todate" />
                    <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span>
                    </span>
                  </div>
