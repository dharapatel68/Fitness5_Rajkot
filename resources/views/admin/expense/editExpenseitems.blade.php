...
<!-- left column -->
  <div class="content-wrapper">
         ...
         <section class="content-header"><h2>Edit Expense</h2></section>
          ...
          <div class="box box-primary">
            ...
            <div class="box-body"> <div class="col-lg-4"></div><div class="col-lg-4">
              ...
              method="post" id="dietitemform" > {{ csrf_field() }} <!-- text
              input --> <!-- text input -->
...
<div class="row">
  ...
  <div class="form-group">
         ...
         Save</button></div>   <div class="col-sm-6"> <a href="{{ url('viewexpenses') }}"class="btn btn-danger btn-block">Cancel</a></div>
