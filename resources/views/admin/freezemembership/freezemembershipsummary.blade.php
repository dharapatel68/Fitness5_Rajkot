...
@endif
 ...
 <td colspan="2" style="text-align: center;"><a href="{{url('freezemembershipreceipt/'.$invoiceno)}}"><b style="font-size: 20px;"> Print  <i class="fa fa-print" style="size: 20px;"></i></b></a></td>
 </tr>
 <tr>
...
$(document).ready(function(){
 ...
 $(document).ready(function(){
    ...
    $.ajax({
      type : "POST",
      url : "{{ route('freezemembershipdevice') }}",
