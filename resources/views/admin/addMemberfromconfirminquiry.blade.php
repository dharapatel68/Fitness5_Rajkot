        ...
        <article class="content-entry open" >
            ...
            <div class="form-group">
              <label>Email</label>
                ...
                <input type="email"  name="email" class="form-control" placeholder="Email Id"  class="span11"  value="{{$member['email']}}" id="email" />
              </div>
                <div class="form-group">
        ...
        <article class="content-entry">
            ...
            <textarea rows="2" cols="20" name="Address" wrap="soft" class="form-control"  placeholder="Address" class="span11"></textarea>
             ...
             <label>Home Phone Number</label>
                ...
                <input type="text" name="HomePhoneNumber" class="form-control number" placeholder="Home Phone Number" id="HomePhoneNumber" minlength="10" maxlength="10" class="span11" />
            ...
            <div class="form-group">
             <label>Office Phone Number</label>
                ...
                <input type="text" name="OfficePhoneNumber" id="OfficePhoneNumber" class="form-control number" placeholder="Office Phone Number"  minlength="10" maxlength="10" class="span11" />
                <span class="errmsg"></span>
               </div>
        ...
        <article class="content-entry">
            ...
            <div class="accordion-content"><br/>
             ...
             <label>Birthdate</label>
                ...
                <input placeholder="Birthdate" type="date" onkeypress="return false" class="form-control" name="birthday" class="span11" max="{{ date('Y-m-d')}}">
...
<!-- 
 ...
 -->
          ...
          <article class="content-entry">
            <h4 class="article-title"><i></i>Fitness Goals & Excercisse Program</h4>
            <div class="accordion-content"><br/>
              <div class="well well-lg">
                <label style="background-color: white; border-width: 20px; border-color: black;">Fitness Goals</label>
