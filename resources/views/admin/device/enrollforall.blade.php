...
<!-- /input-group -->
  ...
  <div class="box box-primary" style="display: none;" id="addmeasurment">
    <div class="row">
          ...
          <div class="col-lg-3">
              <button type="button" class="btn bg-orange" data-toggle="modal" data-target="#enrollmodal" id="enrollcard" style="width: 200px;height: 50px;">Enroll Card</button>
          </div>
  ...
  <div class="modal fade" id="enrollmodal"  role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <a href="{{ url('enrolldevicecomman') }}" class="btn btn-danger">Close</a>
        </div>
      </div>
    </div>
  </div>
...
<script type="text/javascript">
  $('#username1').change(function(){
    $('#memberpackagedetails').css('display', 'none');
    $('#addmeasurment').css('display', 'none');
    $.ajax({
      url : '{{url("getuserajax")}}',
      type : 'GET',
        ...
        success : function(data){
           ...
           if (data[0] != 0) {
            ...
            success : function(data){
              ...
              alert('Enroll Successfuly').delay(5000);
               ...
               // alert(data);
                 ...
                 $.ajax({
                      ...
                      success : function(data){
                        ...
                        alert('Enroll Card Successfuly').delay(5000);
                        window.location.reload();
                   },       
                })
              }
      ...
      if(finalcard && userid){
        ...
        if(unique_card == finalcard){
          $.ajax({
            ...
            data : {userid:userid, finalcard:finalcard, reassigncard:reassigncard, _token : '{{ csrf_token() }}'},
            success : function(data){
              if(data == 201){
