...
@endif 
          ...
          <div class="box box-primary">
            ...
            <div class="box-header with-border">
              <h3 class="box-title">Edit Diet</h3>
            </div>
            <!-- /.box-header -->
             <div class="box-body"> 
              
              <form action="{{url('editDietplan')}}" method="post" name="formtab" id="formtab">
                {{csrf_field()}}
    ...
    $('.tab'+item.dietday+'item:last').after(ap);  
      ...
      var strarray = item.dietitemid.split(',');
          $('.tab'+item.dietday+'items'+counttabedit+'').select2({
            ...
            placeholder: "Please select Multiple Item",
            width: 200
        });
