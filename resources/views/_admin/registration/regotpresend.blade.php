    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="msform" action="{{url('regpostverify')}}" method="post">
            {{ csrf_field() }}
                       ...
                       <div class="row">
                          <div class="form-group">
                            <div class="col-md-6">
                                 ...
                                 <input type="text" name="mobileno" id="mobileno" class="form-control" placeholder="Please Enter Your Mobile Number For OTP Code Again !" maxlength="10" value="{{$regresend->phone_no}}" readonly="">

                                 <input type="hidden" name="email" id="email" value="{{$regresend->email_id}}">

                                 <input type="hidden" name="fname" id="fname" value="{{$regresend->firstname}}">

                                 <input type="hidden" name="lname" id="lname" value="{{$regresend->lastname}}">
                            </div>  
                            <div class="col-md-6">
      ...
      $('#ResendOtp').click(function(){ 
        ...
        $('#error_message').html('');  
                $.ajax({  
                    ...
                    url:'{{ URL::route("registrationresendotp") }}',   
