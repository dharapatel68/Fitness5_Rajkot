...
<section id="content">
  <form action="{{ url('verify') }}" method="post" enctype="multipart/form-data" id="form">  {{ csrf_field() }}
     <input type="hidden" name="memfromreg" value="{{ $memfromreg }}"> 
             ...
             <div class="form-group">
              ...
              <label>User Name</label>
                ...
                <input type="text"  name="username" id="username" class="form-control"placeholder="User Name"  class="span11" required="" value="{{$member['firstname']}}{{$member['lastname']}}" /><span id="error_username"></span>
                    ...
                    <label>
                      <input type="radio" name="gender" class="gender" value="Female" {{ $member['gender'] == 'Female' ? 'checked' : ''}}>
                      Female
                    </label>
                
                    <label>
                      <input type="radio" name="gender" class="gender" value="Male" {{ $member['gender'] == 'Male' ? 'checked' : ''}}>
                      Male
                    </label>
                  </div>
            <div class="form-group">
              <label>Email<span style="color: red;">*</span></label>
                ...
                <input type="email" id="email" name="email" class="form-control" placeholder="Email Id"  class="span11" value="{{$member['email_id']}}" required />
              </div>
                <div class="form-group">
             <label>Cell Phone Number</label>
             
                <input type="text" name="CellPhoneNumber" id="MobileNo" minlength="10" maxlength="10"
        class="form-control number" readonly=""placeholder="Cell Phone Number" required=""  class="span11" value="{{$member['phone_no']}}" /><span id="error_usermobile" ></span>
               </div>
               <div class="form-group">
        ...
        <article class="content-entry" >
            ...
            <textarea rows="2" cols="20" name="emergancyaddress" wrap="soft" class="form-control"  placeholder="Emergancy Address" class="span11"></textarea>
             ...
             <label>Emergancy Contact Number</label>
                ...
                <input type="text" name="EmergancyPhoneNumber" class="form-control number" placeholder="EmergancyPhoneNumber" id="EmergancyPhoneNumber"  minlength="10" maxlength="10" class="span11" />&nbsp;<span class="errmsg"></span>
               </div>
        ...
        <article class="content-entry">
            ...
            <div class="accordion-content"><br/>
              ...
              <label>Hear About..</label>
                   ...
                   <option value="Fitness5 Member">Fitness5  Member</option>
             ...
             <label>Birthdate</label>
                ...
                <input placeholder="Birthdate" type="date" onkeypress="return false" class="form-control" name="birthday" class="span11" value="{{date('Y-m-d',strtotime($member->dob))}}">
            
            </div>
              <div class="form-group">
             <label>Anniversary</label>
             
                <input placeholder="Anniversary" type="date" onkeypress="return false" class="form-control" name="anniversary" class="span11">
...
<!-- 
 ...
 -->
          ...
          <article class="content-entry">
            <h4 class="article-title"><i></i>FitnessGoals & Exercise Program</h4>
            <div class="accordion-content"><br/>
              <div class="well well-lg">
...
<div class="field" align="left">
  ...
  <i id="file"></i>
           ...
           <div class="form-group">
             ...
             <div class="col-sm-offset-4"><button type="submit" class="btn bg-orange margin" onClick="return ValidateForm(this.form)" id="save" >Save</button>
              <button type="button" disabled class="btn bg-orange margin" id="btnnew" style="display: none;">Submitting</button>
...
var checked_gender = $('.gender').is(':checked');
...
if(!fname){
  ...
  return false; 
}else if(checked_gender != true){  //Test if something was checked
...
<script type="text/javascript">
  var regid=<?php echo $register_id ?>;
   ...
   var error_username = '';
    ...
    var _token = $('input[name="_token"]').val();
     ...
     $.ajax({
      ...
      method:"POST",
      data:{username:username,regid:regid, _token:_token},
      success:function(result)
      {
       if(result == 'unique')
       {
