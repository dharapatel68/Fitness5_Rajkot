                                            ...
                                            <div class="col-md-6">
                                               <form action="{{ route('editleave', $Leave_obj->leaveid) }}" method="post" id="workingdays">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select  class="form-control span11 selectpicker"title="Select Year" data-live-search="true" data-selected-text-format="count"  data-actions-box="true"  data-header="Select Year" required="" name="employeeid" id="employee" data-sear>
                                                        @if(!empty($employee))
