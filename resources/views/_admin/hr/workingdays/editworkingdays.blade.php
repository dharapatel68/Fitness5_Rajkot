...
<div class="content-wrapper">
    <section class="content-header">
        <h2>Add Working Days</h2></section>
                            ...
                            <div class="box">
                                ...
                                <div class="box-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <form action="{{ route('editworkingdays', $working_days->workingcalid) }}" method="post" id="workingdays">
                                                    {{ csrf_field() }}
                                                    ...
                                                    <div class="form-group ">
                                                        ...
                                                        <select class="form-control span11 selectpicker"title="Select Month" data-live-search="true" data-selected-text-format="count"  data-actions-box="true"  data-header="Select Month" required="" name="month" data-sear value="{{ $month }}">
                                                    ...
                                                    <div class="form-group ">
                                                        ...
                                                        <input type="text" name="workingdays" value="{{ $workingdays }}" class="form-control number" maxlength="2" required="">
