...
@endif
          ...
          <div class="box box-primary">
            ...
            <div class="box-header with-border">
              <h3 class="box-title"><b>Send Inquiry Notification</b></h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body"> 
              <div class="col-lg-12">
                <div class="row">
                  <form action="{{url('sendinquirysms')}}" method="post">
                    {{ csrf_field() }}
                  <div class="col-lg-3">
                    <div class="">
                    <label>Status</label>
                       <select name="istatus[]" multiple="multiple" id=""  class="form-control selectpicker" title="Select Member Status" data-live-search="true" data-selected-text-format="count"  data-actions-box="true"  data-header="Select Member Status">
                          <!-- <option selected value="" disabled="" >--Please choose an option--</option> -->
                          <option @if(Session::get("istatus")) @if(in_array('2', Session::get("istatus"))) selected="" @endif  @endif value="2">Confirm Inquiry</option>
                          <option @if(Session::get("istatus")) @if(in_array('3', Session::get("istatus"))) selected="" @endif @endif  value="3">Conver Into Member</option>
                          <option @if(Session::get("istatus")) @if(in_array('1', Session::get("istatus"))) selected="" @endif  @endif  value="1">Pendding Inquiry</option>
                          <option @if(Session::get("istatus"))  @if(in_array('0', Session::get("istatus")))selected="" @endif @endif  value="0">Closed Inquiry</option>
                ...
                <div class="col-lg-3">
                    ...
                    <label>Ratting</label>
                       <select name="rattingstatus[]" multiple="multiple" id=""  class="form-control selectpicker" title="Select Member Status" data-live-search="true" data-selected-text-format="count"  data-actions-box="true"  data-header="Select Member Status">
                          <!-- <option selected value="" disabled="" >--Please choose an option--</option> -->
                          <option @if(Session::get("rattingstatus")) @if(in_array('superhot', Session::get("rattingstatus"))) selected="" @endif  @endif value="superhot">SuperHot</option>
                          <option @if(Session::get("rattingstatus")) @if(in_array('hot', Session::get("rattingstatus"))) selected="" @endif  @endif value="hot">Hot</option>
                          <option @if(Session::get("rattingstatus")) @if(in_array('warm', Session::get("rattingstatus"))) selected="" @endif  @endif value="warm">Warm</option>
                          <option @if(Session::get("rattingstatus")) @if(in_array('cold', Session::get("rattingstatus"))) selected="" @endif  @endif value="cold">Cold</option>
                          <option @if(Session::get("rattingstatus")) @if(in_array('notinterested', Session::get("rattingstatus"))) selected="" @endif  @endif value="notinterested">Not Intersted</option>
                ...
                <div class="col-lg-3">
                    <div class="">
                    <label>To date</label>
                      <input type="date" class="form-control" id="tdate"  @if(Session::get("tdate")) value="{{ Session::get("tdate") }}" @endif name="tdate">
                  </div>
                </div>
              </div>
                ...
                <div class="col-lg-2">
                    <div class="">
                      <label class="container">Male
                         <input type="checkbox" name="smsmale"  @if($male = Session::get("smsmale")) checked="" @endif class="smsgender" id="smsmale" value="male">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            ...
                            <div class="box">
                                    ...
                                    <div class="box-header">
                                        <h3 class="box-title">Inquires Users</h3>
                                    </div>
