  ...
  box-shadow: none !important;
    ...
    <div class="col-lg-4">
                ...
                <div class="col-lg-5">
                  ...
                  <select  class="form-control select2" multiple="" data-placeholder="Select a Tags" style="width: 100%;" tabindex="-1" aria-hidden="true"  name="exerciselevel[]" required="" id="tagsid">
            ...
            <div class="col-md-3">
                  <div class="l"><button type="button" style="margin-top: 23px;"class="btn btn bg-orange" name="plan" id="plan" value="plan">Assign</button></div>
                </div>
...
?>
  ...
  // $("#tab3set"+counttab3).keypress(function(e){
  //   var keyCode = e.which;
...
?>
  ...
  //   $("#tab4set"+counttab4).keypress(function(e){
  //   var keyCode = e.which;
...
?>
  ...
  //   $("#tab5set"+counttab5).keypress(function(e){
  //   var keyCode = e.which;
...
?>
  ...
  //   $("#tab6set"+counttab6).keypress(function(e){
  //   var keyCode = e.which;
...
?>
  ...
  //   $("#tab7set"+counttab7).keypress(function(e){
  //   var keyCode = e.which;
                                  ...
                                  success:function(data) {
                                    ...
                                    if(data){
                                      ...
                                      $.each(data, function(i, item){
                                              ...
                                              var ap='<tr id="tab'+item.exerciseplanday+'firsttr'+counttabedit+'" class="tab'+item.exerciseplanday+'item"><td><div class="form-group"><select class="form-control" name="tab'+item.exerciseplanday+'exercisename'+counttabedit+'"><option value="" disabled="" selected="">--Please select--</option>';
