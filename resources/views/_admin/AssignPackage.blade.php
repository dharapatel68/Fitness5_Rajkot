                ...
                <div class="col-lg-6">
                  <div class="input-group">
                    ...
                    <select name="selectusername" id="selectusername" readonly class="form-control" ><option selected disabled="">--Please choose an option--</option>
                        <option selected=""  value=" {{$usermember->memberid}}">{{$usermember->username}}</option></select>
  ...
  <div class="col-lg-6">
      <div class="input-group">
        ...
        <select name="selectmobileno" id="selectmoblieno"  disabled="true" class="form-control" ><option selected disabled="">--Please choose an option--</option>
                                <option selected="" value="{{$usermember->memberid}}">{{$usermember->mobileno}}</option>
                            </select>
           ...
           <div class="form-group">
               ...
               <input type="text" name="MembershipAmount" id="MembershipAmount" class="form-control" placeholder="Membership Amount" readonly=""  class="span11" />
       ...
       <div class="col-md-5">
           ...
           <div class="form-group">
               ...
               <input placeholder="Joining date"   onchange="assigndate()" type="date" onkeypress="return false" value="<?php echo date('Y-m-d');?>" id="startingdate" class="form-control" name="Join_date" class="span11">
          ...
          <div class="col-lg-8">
              <div class="form-group">
               <div class="col-sm-offset-6">
                 <p class="btn bg-blue margin" id="save" onclick="checkform()">Save</p>
...
function assigndate() {
    ...
    $('#username').on('keyup', function() {
     ...
     $('#scheme').on('change', function(){
     let scheme = $(this).val();
     let user_id = $('#selectusername').val();
