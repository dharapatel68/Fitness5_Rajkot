...
@endif 
          ...
          <div class="box box-primary" id="firststep">
            ...
            <div class="box-body" ><div class="col-lg-6"><h4><u>Personal Details</u></h4> 
             ...
             <label>Date</label>
                ...
                <input placeholder="date" type="date" onkeypress="return false" class="form-control" name="Created_date" class="span11" value="{{Carbon\Carbon::today()->format('Y-m-d')}}">
 ...
 class="form-control number" placeholder="Cell Phone Number"   class="span11" value="{{$useredit->Member->CellPhoneNumber}}"/>
             ...
             <label>Birthdate</label>
                ...
                <input placeholder="Birthdate" type="date" onkeypress="return false" class="form-control" name="birthday" class="span11" value="{{$member->Birthday}}">
            
            </div>
              <div class="form-group">
             <label>Anniversary</label>
             
                <input placeholder="Anniversary" type="date" onkeypress="return false" class="form-control" name="anniversary" class="span11" value="{{$member->Anniversary}}">
