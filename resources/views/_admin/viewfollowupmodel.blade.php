 ...
 @if(count($errors)>0)
  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
      ...
      <div class="row mx-auto" style="height:30px;"></div>
        ...
        <div class="form-group">
          ...
          <div class="col-md-3">
            <label for="CallResponse">Call Response</label>
             <select class="form-control" id="exampleFormControlSelect1" name="callresponse" required="">
          ...
          <div class="col-md-2">
            <label for="CallDuration">Call Duration</label>
             <select class="form-control" id="exampleFormControlSelect1" name="callduration" required="">
          ...
          <div class="col-md-3">
            ...
            <select class="form-control" required="" id="exampleFormControlSelect1" name="callqulity">
       ...
       <div class="row">
         ...
         <div class="form-group"> 
            ...
            @php $pacintrest = $followupid->packagename; @endphp
            {{$pacintrest}}
            <select class="form-control" name="package">
				<option value="" disabled="">-- Please Select Package --</option>
                @foreach($package as $pac)
                <option value="{{$pac->schemename}}"{{($pac->schemename == $pacintrest) ? 'selected':''}}>{{$pac->schemename}}</option>
      ...
      <br>
      <center>
          <button id="schedulereminder" type="button" class="btn1 schedulereminder ">Schedule Reminder</button></center>
      <div class="row schedule" style="display: none;">
          ...
          <div class="form-group">
            <div class="col-md-6 col-md-offset-2">
              <label for="PackageInterestedIn">Schedule Next Call Date</label>
                 ...
                 <input  type="text" id="scheduledate" class="form-control" name="scheduledate" placeholder="<?php echo date("d-m-Y"); ?>" value="" autocomplete="off">
            </div>
          </div>
       </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-6">
                   <label for="FreeTrialOn">Free Trial On</label>
                      <input  type="text" id="freetrialdate" class="form-control" name="freetrialdate" placeholder="<?php echo date("d-m-Y"); ?>"autocomplete="off" value=""> 
                </div>
              </div>
            </div>
...
$('.schedulereminder').on('click',function(){
  $('.schedule').toggle();
