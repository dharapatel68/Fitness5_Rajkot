      ...
      <article class="content-entry open">
         ...
         <div class="well well-lg">
            <div class="form-group">
               ...
               <input type="text" name="firstname" id="firstname" class="form-control" placeholder="Firstname" class="span11" required="" maxlength="60" value="{{ old('firstname') }} @if($memberdata->firstname){{ $memberdata->firstname }} @endif" />
            </div>
            <div class="form-group">
               <label>LastName<span style="color: red">*</span>
               </label>
               <input type="text" name="lastname" id="lastname" class="form-control inline-block" placeholder="LastName" class="span11" maxlength="60" value="{{ old('lastname') }}@if($memberdata->lastname){{ $memberdata->lastname }} @endif" required="" />
            </div>
            <div class="form-group">
               <label>User Name</label>
               <input type="text" name="username" id="username" class="form-control" placeholder="User Name" class="span11" required="" maxlength="60" value="{{ old('username') }} @if($memberdata->username){{ $memberdata->username }} @endif" /><span id="error_username"></span>
            </div>
            <div class="form-group">
               <label>Gender<span style="color: red">*</span>
               </label>
               <label>
               <input type="radio" name="gender" value="Female" required   @if($memberdata->gender){{ $memberdata->gender  == 'Female' ? 'checked' : ''}} @endif >Female</label>
               <label>
               <input type="radio" name="gender" value="Male"  @if($memberdata->gender){{ $memberdata->gender  == 'Male' ? 'checked' : ''}} @endif>Male</label>
            </div>
            <div class="form-group">
               <label>Email<span style="color: red">*</span>
               </label>
               <input type="email" maxlength="60" value="{{ old('email') }} @if($memberdata->email){{ $memberdata->email }} @endif" id="email" name="email" class="form-control" placeholder="Email Id" class="span11" required />
            </div>
            <div class="form-group">
               <label>Cell Phone Number<span style="color: red">*</span>
               </label>
               <input type="text" name="CellPhoneNumber" value="{{ old('mobileno') }} @if($memberdata->mobileno){{ $memberdata->mobileno }} @endif" id="MobileNo" minlength="10" maxlength="10" class="form-control number" placeholder="Cell Phone Number" required="" class="span11" /><span id="error_usermobile"></span>
            </div>
            <div class="form-group">
               ...
               <option value="07:00" @if(old( 'working_hour_to_1')=='07:00' ) selected @endif @if($memberdata->mobileno) {{ $memberdata->mobileno =='22:00' ? 'selected' : ''}}  @endif >07:00 AM</option>
