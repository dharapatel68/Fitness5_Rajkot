               ...
               <div id="Followupdetails" class="addfollowers">
                <div class="form-group">
                  ...
                  <input type="text" name="Reason" class="form-control" required="">
                    ...
                    <div><b>Followup Date</b><input type="date" onkeypress="return false" name="FollowUpDays" value="{{Carbon\Carbon::today()->addDays(3)->format('Y-m-d')}}" class="form-control"></div>
