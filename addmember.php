...
<section class="content-header text-center"> 
   <img src="public/images/fitness5.png" height="100px" width="100px"><h2>Membership Form</h2>
</section>
...
<section id="content">
   <form action="/dsh.php" method="post" enctype="multipart/form-data" enctype="multipart/formdata" id="member_form" onsubmit = "return ValidateForm();">
